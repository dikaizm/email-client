...
from mail.services.gmail import label
from mail.services.gmail.attachment import Attachment
from mail.services.gmail.label import Label
from mail.services.gmail.message import Message
...
class GmailService(object):
    ...
    def __init__(
        ...
        self.user = user
        self.creds = oauth_get_credentials(user)
    ...
    def _get_messages_from_refs(
        ...
        def thread_download_batch(thread_num):
            gmail = GmailService(user=self.user)
    ...
    def _evaluate_message_payload(
        ...
        if 'attachmentId' in payload['body']:  # if it's an attachment
            ...
            body = BeautifulSoup(data, 'html.parser').body
